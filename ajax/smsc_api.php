...
define("SMSC_LOGIN", "hogart-art");			// логин клиента
define("SMSC_PASSWORD", "5b931c5cbfa2639975a155a1e727855b");	// пароль или MD5-хеш пароля в нижнем регистре
...
{
	static $formats = array(1 => "flash=1", "push=1", "hlr=1", "bin=1", "bin=2", "*=1", "mms=1", "mail=1", "call=1");
