        ...
        <div disabled="disabled" class="" data-delivery-type="<?= OrderRTUTable::DELIVERY_OUR ?>">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <label class="pull-right">
                        Новый контакт <input data-switch type="checkbox" name="new_contact" value="1">
                    </label>
                </div>
            </div>
            <div class="row spacer">
            ...
            <div class="row">
                <div class="col-sm-12 center-between">
                    ...
                    <label class="pull-right">
                        Новый адрес <input data-switch type="checkbox" name="new_address" value="1">
                    </label>
                </div>
            </div>
            <div class="row spacer">
                ...
                <div class="col-sm-6 text-right">
                    <label>
                        Транспортная компания <input data-switch type="checkbox" name="is_tk" value="1">
                    </label>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="row spacer">
                        ...
                        <div class="col-sm-6 text-right">
                            <label>
                                Оповещать по смс <input data-switch type="checkbox" name="is_sms_notify" value="1">
                            </label>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row spacer">
                        ...
                        <div class="col-sm-6 text-right">
                            <label>
                                Оповещать по E-mail <input data-switch type="checkbox" name="is_email_notify" value="1">
                            </label>
                        </div>
                    </div>
                </div>
