...
class Money
{
     ...
     * @return mixed|string
     */
    public static function toStr($number, $asPrice = true, $currency = 'RUB')
    {
        $words = array(
            'null' => 'ноль',
            ...
            'r1' => ' рубль', 'r2' => ' рубля', 'r5' => ' рублей', 'rp' => 'коп.',
            'e1' => ' евро', 'e2' => ' евро', 'e5' => ' евро', 'ep' => 'цен.',
        ...
        if ($asPrice) {
            ...
            $label = (($c == 1) ? $prefix . '1' : (($c > 1 && $c < 5) ? $prefix . '2' : $prefix . '5'));
            $result .= $words[$label] . ' ' . $kop . ' ' . $words[$prefix . 'p'];
        }
        return $result;
    }
}