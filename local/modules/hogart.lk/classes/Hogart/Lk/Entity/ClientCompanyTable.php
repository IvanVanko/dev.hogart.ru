...
class ClientCompanyTable extends AbstractEntity
{
    ...
    public static function getMap()
    {
        return [
            ...
            new ReferenceField("kind_activity", "Hogart\\Lk\\Entity\\KindActivityTable", ["=this.kind_activity_id" => "ref.id"]),
            new StringField("inn"),
            new StringField("kpp"),
            new DateField("date_fact_address"),
            new IntegerField("chief_id"),
            new ReferenceField("chief", "Hogart\\Lk\\Entity\\ContactInfoTable", ["=this.chief_id" => "ref.id"]),
