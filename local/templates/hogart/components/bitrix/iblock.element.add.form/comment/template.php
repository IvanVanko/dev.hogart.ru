						...
						switch ($INPUT_TYPE):
							...
							case "T":
								for ($i = 0; $i<$inputNum; $i++)
								{
									...
									$class = "js-validation-empty";
									if(!in_array($propertyID, $arParams["PROPERTY_CODES_REQUIRED"])){
                                        $class = "not";
									}
								?>
                                ...
                                <div class="field custom_upload white-btn otz-b">
                                    ...
                                    <!--<div class="field custom_label js-validation-empty">
                                        <label for="<?/*= $arResult['PREVIEW_PICTURE']*/?>">
                                            Фото
                                        </label>
                                        <input type="file" name="<?/*= $arResult['PREVIEW_PICTURE']*/?>" value=""/>
                                    </div>-->
								<?
								}
							break;
							...
							case "N":
								for ($i = 0; $i<$inputNum; $i++)
								{
									...
									if($propertyID == "NAME"){
									    $arResult["PROPERTY_LIST_FULL"][$propertyID]['IS_REQUIRED'] = 'Y';
									}
									$class = "js-validation-empty";
