        ...
        if (isset($arItem["PRICE"])):
            ...
            <div class="group-field">
                ...
                <div class="field">
                    ...
                    <input class="slider-min" type="hidden" name="<?= $arItem["VALUES"]["MIN"]['CONTROL_NAME'] ?>"
                           value="<?= $input_min_value ?>"/>
                    <input class="slider-max" type="hidden" name="<?= $arItem["VALUES"]["MAX"]['CONTROL_NAME'] ?>"
                           value="<?= $input_max_value ?>"/>
                </div>
            </div>
        <?endif;
    }
                ...
                <div class="bx_filter_select_container">
                    <div class="bx_filter_select_block"
                        ...
                        <div class="bx_filter_select_popup" data-role="dropdownContent" style="display: none;">
                            <ul>
                                <li>
                                    <label for="<?= "all_" . $arCur["CONTROL_ID"] ?>" class="bx_filter_param_label"
                                ...
                                foreach ($arItem["VALUES"] as $val => $ar):
                                    ...
                                    ?>
                                    <li>
                                        <label for="<?= $ar["CONTROL_ID"] ?>" class="bx_filter_param_label<?= $class ?>"
            ...
            <?
                ...
                <div class="breands hide-big-cnt" data-hide="<?= $arItem["HINT"] ?>">
                    ...
                    <? if (count($arItem["VALUES"]) > 3) {
                        $hiddenValues = array_splice($arItem["VALUES"], 3, count($arItem["VALUES"]) - 3);
                    } ?>
