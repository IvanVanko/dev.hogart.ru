...
?>
<div class="padding small-top-padding">
<form name="<?=$arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get">
		...
		if (isset($arItem["PRICE"])):
            ...
            <div class="field">
                <div 
                	...
                	<?if (intval($arItem["VALUES"]["MAX"]["HTML_VALUE"])):?>
                		data-value="<?=$arItem["VALUES"]["MIN"]["HTML_VALUE"]?>,<?=$arItem["VALUES"]["MAX"]["HTML_VALUE"]?>"
                	<?else:?>
                		data-value="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>,<?=$arItem["VALUES"]["MAX"]["VALUE"]?>" 
                	<?endif;?>
	...
	<br /><br /><br />
    <a href="<?=$APPLICATION->GetCurDir(true)?>?q=<?=$_REQUEST['q']?>&section_id=<?=$_REQUEST['section_id']?>" class="empty-btn link">сбросить запрос</a>
	<br />
	<br />
</form>
</div>
