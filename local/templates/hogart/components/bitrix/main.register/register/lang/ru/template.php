...
$MESS["REGISTER_FIELD_WORK_NOTES"] = "ВАШ МЕНЕДЖЕР В ХОГАРТЕ";
$MESS["REGISTER_EMAIL_WILL_BE_SENT"] = "На указанный в форме e-mail придет запрос на подтверждение регистрации.";
$MESS["MAIN_REGISTER_AUTH"] = "Спасибо! Ваша заявка принята. В ближайшее время с вами свяжется менеджер компании для уточнения деталей.";
