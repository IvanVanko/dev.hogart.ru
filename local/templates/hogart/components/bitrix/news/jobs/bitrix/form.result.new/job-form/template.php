...
<div class="js-validation-form-new">
    <div class="js-validation-form-new-answer" style="display: none;"></div>
    <script type="text/javascript" src="<?=$templateFolder;?>/script-ajax.js"></script>
	...
	<?foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion):?>
		...
		elseif ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'textarea'):?>
			<div class="field">
                ...
                <a class="trigger-border-bottom<?=($arQuestion["CAPTION"]=='Сопроводительное письмо')? ' sopr':'';?>" href="#"><?=$arQuestion["CAPTION"]?></a>
