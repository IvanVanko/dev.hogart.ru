...
?>
    ...
    <footer class="b-footer">
        <div class="oldschool-logo t-text_center">
            <a target="_blank" href="http://oldschool.agency">
                <span>сделано в</span>
                <img class="svg" src="/images/svg/logo-oldschool.svg">
            </a>
        </div>
        <div class="b-footer__copyright">© 2017, HOGART, 117041 г. Москва, ул Поляны, 52</div>
