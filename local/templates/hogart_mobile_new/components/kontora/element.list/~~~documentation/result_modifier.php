...
foreach ($arResult['ITEMS'] as $key => $arItem) {
	...
	$arItem["FILE"] = $file;
	$arResult['ITEMS'][$key]["FILE"] = $arItem["FILE"];
...
foreach ($arResult['ITEMS'] as $key => $arItem) 
{
	$arData[$arItem["PROPERTY_BRAND_NAME"]][$i] = $arItem;
	$i++;
}
$arResult['DOCUMS'] = $arData;
BXHelper::addCachedKeys($this->__component, array('DOCUMS'), $arResult);
#DebugMessage($arData);