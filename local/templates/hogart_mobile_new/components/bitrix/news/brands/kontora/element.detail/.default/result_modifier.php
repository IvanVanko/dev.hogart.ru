...
$res = CIBlockSection::GetList(array('SORT' => 'ASC'), array('IBLOCK_ID' => 1, 'ID' => $arSectionsIds), false, array('ID','NAME','IBLOCK_SECTION_ID','PICTURE','SECTION_PAGE_URL'));
...
$res = CIBlockSection::GetList(array('SORT' => 'ASC'), array('IBLOCK_ID' => 1, 'ID' => $arParentSectionIds), false, array('ID','NAME','IBLOCK_SECTION_ID','PICTURE','SECTION_PAGE_URL'));
