...
<div class="inner-wrap contacts-content">
	...
	<dl>	
		...
		<dt>Телефон</dt>
			<dd>
				<a href="tel:<?=$arResult['PROPERTIES']['phone']['VALUE']?>"><?=implode('<br>', $arResult['PROPERTIES']['phone']['VALUE'])?></a><br>
			</dd>
		<?endif;?>
		<?if (!empty($arResult['PROPERTIES']['mail']['VALUE'])):?>
		<dt>E-mail</dt>
			<dd>
				<a href="mailto:<?=$arResult['PROPERTIES']['mail']['VALUE']?>"><?=implode('<br>', $arResult['PROPERTIES']['mail']['VALUE'])?></a><br>
				<!--<?$email_html = array();
