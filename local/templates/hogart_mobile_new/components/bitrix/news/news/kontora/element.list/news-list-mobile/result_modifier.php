...
$res = CIBlockElement::GetList(array('NAME' => 'ASC'), $arFilter, array("PROPERTY_BRAND"), false, array());
while ($ob = $res->GetNextElement()) {
	$arFields = $ob->GetFields();
...
$arDirections = array();
$rsSect = CIBlockSection::GetList(array("NAME" => "ASC"), array('ID' => $arDirectionsID));
