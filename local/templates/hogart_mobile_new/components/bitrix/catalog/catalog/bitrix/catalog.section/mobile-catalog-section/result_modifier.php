...
foreach ($arResult["ITEMS"] as $k=>$arV)
{
    if (eregi("#BRAND#", $arV["DETAIL_PAGE_URL"]))
    {
            $arResult["ITEMS"][$k]["DETAIL_PAGE_URL"]       = str_replace("#BRAND#/","", $arResult["ITEMS"][$k]["DETAIL_PAGE_URL"]);
            $arResult["ITEMS"][$k]["~DETAIL_PAGE_URL"]       =  $arResult["ITEMS"][$k]["DETAIL_PAGE_URL"];
        }
}
#DebugMessage($arResult["ITEMS"][0]);
?>