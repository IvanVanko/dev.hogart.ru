...
?>
<?jsDump($arResult["DISPLAY_PROPERTIES"]);?>
        ...
        <div class="bxslider">
            <ul class="bx-wrap" id="js-scale-01">
                <? if (!empty($arResult['DETAIL_PICTURE']['SRC'])) { ?>
                    <li>
                        <div class="img-wrap">
                            <img title="<?=$arResult['NAME']?>" src="<?= $arResult['DETAIL_PICTURE']['SRC'] ?>" data-group="producPop"
                ...
                <? }else{ ?>
                    <li>
                        <div class="img-wrap">
                            <img src="/images/no-img-big.jpg" data-group="producPop" class="js-popup-open-img" alt=""/>
                        </div>
                    </li>
                <?}; ?>
            </ul>
                    ...
                    <div class="product-info-block">
                        ...
                        <? if ($USER->IsAuthorized() && !empty($arResult["PRICES"]["BASE"]["DISCOUNT_DIFF_PERCENT"])): ?>
                            <div class="info-block">
                                ...
                                <div class="old currency-<?=strtolower($arResult["PRICES"]["BASE"]["CURRENCY"])?>"><?=HogartHelpers::wPrice($arResult["PRICES"]["BASE"]["PRINT_VALUE"]);?></div>
                                ...
                                <div class="col2">
                                    <div class="icon-carTon grid-hide">
                                        ...
                                        <? if (!empty($arResult["PROPERTIES"]["delivery_period"]["VALUE"])): ?>
                                            <br>
                                            <span>Срок поставки <?= $arResult["PROPERTIES"]["delivery_period"]["VALUE"] ?> <?= number($arResult["PROPERTIES"]["delivery_period"]["VALUE"], array('день', 'дня', 'дней')) ?></span>
                                        <? endif; ?>
                                    </div>
                                </div>
                        ...
                        <div class="features doc-features">
                            ...
                            <div class="doc-cnt mCustomScrollbar" data-mcs-theme="dark">
                                <? foreach ($arResult["DOCS"] as $arDocument): ?>
                                    <a class="file-pdf" target="_blank" href="<?= $arDocument["FILE"]["SRC"] ?>">
                                        <?= $arDocument["NAME"] ?>
    ...
    <div class="features">
        ...
        <div class="features-cnt">
            ...
            <?if (!empty($arHiddenProperties)) {?>
                ...
                <dl data-active-label="Скрыть" data-hidden-label="Все характеристики" data-collapse="#show-element-props" class="features-show-all">
            ...
            <? foreach ($arResult["buy_with_this"] as $key => $arProduct): ?>
                <li>
                    ...
                    <div class="param">
                        ...
                        <?=HogartHelpers::getAdjacentProductPropertyHtml($arProduct['ID'],$arProduct["SHOW_PROPS"],$arProduct["HIDDEN_PROPS"], array('brand','photos','sku','collection'));?>
                    </div>
