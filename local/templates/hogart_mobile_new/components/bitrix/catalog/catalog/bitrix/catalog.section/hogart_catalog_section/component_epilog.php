...
$_arChains = $APPLICATION->arAdditionalChain;
$arChains[] = array_shift($_arChains);
$arChains[] = array_pop($_arChains);
$APPLICATION->arAdditionalChain = $arChains;
#DebugMessage($arChains);