                    ...
                    <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>">
                        ...
                        <? if (!empty($arItem["PREVIEW_PICTURE"]['SRC'])): ?>
                            ...
                            $file = CFile::ResizeImageGet(
                                            $arItem["PREVIEW_PICTURE"]['ID'], array("width" => 400, "height" => 300), BX_RESIZE_IMAGE_PROPORTIONAL, true
                            );
                            ?>
                        ...
                        <? elseif (!empty($arItem['PROPERTIES']['photos']['VALUE'][0])): ?>
                            <?
                            $file = CFile::ResizeImageGet(
                                            $arItem['PROPERTIES']['photos']['VALUE'][0], array("width" => 400, "height" => 300), BX_RESIZE_IMAGE_PROPORTIONAL, true
                            );
                            ?>
                            <img src="<?= $file['src'] ?>" alt=""/>
                        <? else:
