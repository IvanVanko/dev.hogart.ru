...
<?=$arResult["FORM_HEADER"]?>
	<?foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion):?>
		...
		<?if ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'hidden'):?>
			...
			<?if ($arQuestion['STRUCTURE'][0]["ID"] == 27):?>
				<input type="hidden" name="form_<?=$arQuestion['STRUCTURE'][0]["FIELD_TYPE"]?>_<?=$arQuestion['STRUCTURE'][0]["ID"]?>" value="<?=$arParams["SEMINAR_ID"]?>" />
				<?continue;?>
			<?endif;?>	
		<?endif;?>
		<div class="field">
