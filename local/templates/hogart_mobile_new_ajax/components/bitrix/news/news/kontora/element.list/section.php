...
<!--        <div class="side_href">-->
<!--            <a href="/documentation/?direction=--><?//=$curSection['ID']?><!--&direction_--><?//=$curSection['ID']?><!--_left=--><?//=$curSection['LEFT_MARGIN']?><!--&direction_--><?//=$curSection['ID']?><!--_right=--><?//=$curSection['RIGHT_MARGIN']?><!--?>" class="icon_doc">Перейти<br>к документации</a>-->
<!--            <a href="/selection-equipment/?direction=--><?//=$curSection['ID']?><!--" class="icon_ok">Заявка<br>на подбор<br>оборудования</a>-->
<!--        </div>-->
    <?
    if ($DEPTH_LEVEL == 1) {
