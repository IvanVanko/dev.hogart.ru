...
<div class="news-items">
	<section class="news-one">
		...
		<? if (strlen($arResult['DETAIL_PICTURE']['SRC']) > 0):?>
			...
			<?$photo = CFile::ResizeImageGet($arResult['DETAIL_PICTURE'], array('width'=>320, 'height'=>320), BX_RESIZE_IMAGE_PROPORTIONAL, true);?>
	 	...
	 	<div class="one-news-slider">
	 		<div class="owl-carousel" data-pagination="false">
				<?foreach ($arResult['PROPERTIES']['photogallery']['VALUE'] as $key => $photo):
					...
					$photo = CFile::ResizeImageGet($photoBig, array('width'=>320, 'height'=>320), BX_RESIZE_IMAGE_PROPORTIONAL, true);
					if  (!$key) {
