$(document).ready(function () {
    ...
    $('.js-validation-form-new').submit(function (e) {
        $(this).find('.js-validation-empty select').each(function () {
            ...
            if (!isEmpty($(this).val())) {
                e.preventDefault();
                $(this).parent().addClass('error').attr({'data-error': messages[$('html').data('lang')]['Заполните, пожалуйста, это поле']});
            }
            else {
        ...
        $(this).find('.js-validation-empty .inputfile').each(function () {
            ...
            if (!isEmpty($(this).val())) {
                ...
                $(this).parent().addClass('error').attr({
                    'data-error': messages[$('html').data('lang')]['Заполните, пожалуйста, это поле']
                });
            }
            else {
                $(this).parent().removeClass('error')
        ...
        $(this).find('.js-validation-phone .inputtext').each(function () {
            ...
            if (!isEmpty($(this).val())) {
                ...
                if (!isPhone($(this).val())) {
                    e.preventDefault();
                    $(this).parent().addClass('error').attr({'data-error': messages[$('html').data('lang')]['Заполните это поле правильно']});
                }
                else {
                    $(this).parent().removeClass('error')
                }
        ...
        $(this).find('.js-validation-email .inputtext').each(function () {
            ...
            if (!isEmpty($(this).val())) {
                ...
                if (!isEmail($(this).val())) {
                    e.preventDefault();
                    $(this).parent().addClass('error').attr({'data-error': messages[$('html').data('lang')]['Введите настоящий E-mail']});
                }
                else {
                    $(this).parent().removeClass('error')
                }
