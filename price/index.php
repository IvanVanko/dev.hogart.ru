		...
		<ul class="b-price-list">
            ...
            <? foreach ($catalogMenu as $catalogItem): ?>
                <li class="b-price-list__item">
                    <a href="<?= $catalogItem[1] ?>" class="b-price-list__title" title="<?= $catalogItem[0] ?>">
                    ...
                    <div class="b-price-list__information">
                        ...
                        <? if(!empty($catalogItem[3]["PRICE"])): ?>
                            ...
                            <a href="<?= CFile::GetPath($catalogItem[3]["PRICE"]); ?>" class="b-price-list__link" title="<?= $catalogItem[3]["PRICE_LABEL"] ?>">
